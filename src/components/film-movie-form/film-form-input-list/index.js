...
const FilmFormInputList = ({ setFilm, film }) => {
  ...
  return (
    <div className='film_form_input_list'>
      ...
      <div className='input_container genre'>
        ...
        <select
          className='input_style genre'
          value={film.genres}
          onChange={e => handleInputChange(e, 'genres')}
        >
          <option disabled className='input_style'>
            Select Genre
          </option>
      ...
      <div className='input_container overview'>
        ...
        <textarea
          ...
          className='input_style overview'
        />
      </div>
    </div>
  );
